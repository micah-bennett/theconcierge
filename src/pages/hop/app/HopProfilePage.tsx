    ...
    <div className="hop-page-body">
      ...
      <div className="hop-block-grid">
        ...
        <section className="hop-card hop-block">
          <div className="hop-block__head">
            <span className="hop-icon-chip hop-icon-chip--gold">
              <HopIcon name="appearance" size={20} />
            </span>
            <h2>Appearance</h2>
          </div>
        ...
        <section className="hop-card hop-block">
          <div className="hop-block__head">
            <span className="hop-icon-chip hop-icon-chip--violet">
              <HopIcon name="security" size={20} />
            </span>
            <h2>Security</h2>
          </div>
          <p className="hop-muted">
        ...
        <section className="hop-card hop-block">
          <div className="hop-block__head">
            <span className="hop-icon-chip hop-icon-chip--cyan">
              <HopIcon name="integrations" size={20} />
            </span>
